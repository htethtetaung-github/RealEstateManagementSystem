				...
				<form action="admin" method="post">
					...
					<div class="sign-up-form">
						...
						<div class="group">
							...
							<input id="phone" name="phone" type="text" class="input"  placeholder="Enter your contact number" >
						</div>
						<div class="group">
							<label for="address" class="label">Address</label>
							<input id="address" name="address" type="text" class="input"  placeholder="Enter your address" >
						</div>
